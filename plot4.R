...
##Plot 4: grid of 4 different plots, 2 of which were already created in plots 2 and 3
##Set up 2x2 grid with column-wise filling
par(mfcol=c(2,2))

##Top LH graph
plot(plotData3$DateTime, plotData3$Global_active_power, type="n", xlab="",ylab="Global Active Power (kilowatts)")
lines(plotData3$DateTime, plotData3$Global_active_power, type = "l")
...
##Top RH graph
plot(plotData3$DateTime, plotData3$Voltage, type="n", xlab="datetime",ylab="Voltage")
lines(plotData3$DateTime, plotData3$Voltage, type = "l")

##Bottom RH graph
plot(plotData3$DateTime, plotData3$Global_reactive_power, type="n", xlab="datetime",ylab="Global_reactive_power")
lines(plotData3$DateTime, plotData3$Global_reactive_power, type = "l")